...
export default function AppAnswer({ route, navigation}) {
  ...
  if (errorMsg) {
    ...
    return (
      ...
      <View style={styles.container}>
        ...
        <Text style={styles.title}>Responder questionário</Text>
        ...
        <TextInput 
          ...
          <TextInput 
            ...
            <Text style={styles.textQuestion} onChangeText={handleLatChange} value={location} >Latitude: {location}</Text>
            <Text style={styles.textQuestion} onChangeText={handleLongChange} value={location1} >Longitude: {location1}</Text>
